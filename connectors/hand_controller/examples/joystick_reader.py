        ...
        while True:
            ...
            if event:
                ...
                if event_type == JS_EVENT_BUTTON:
                    ...
                    print(
                        f"[{timestamp_str}] BUTTON {number:2d} {state:8s} {init_flag}"
                    )
                    ...
                    print(
                        f"[{timestamp_str}] AXIS {number:2d} {value:6d} [{bar}] {percentage:6.1f}%{init_flag}"
                    )

                else:
                    print(
                        f"[{timestamp_str}] UNKNOWN EVENT: type={event_type}, number={number}, value={value}"
                    )
