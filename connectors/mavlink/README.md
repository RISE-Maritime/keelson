...
| --- | --- | --- | --- |
| Uplink | Pub/sub publish (Keelson Envelopes wrapping typed payloads) | `vehicle_mode`, `location_fix`, `roll_deg`, `entity_health`, … (31 subjects: 30 from 15 MAVLink message types + `parameter_metadata` from Keelson) | [ZENOH_API.md § Published telemetry](./ZENOH_API.md#published-telemetry-uplink) |
