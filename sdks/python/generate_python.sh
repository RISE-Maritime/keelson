...
uv run protoc \
    ...
    --proto_path=../../messages/payloads \
    --descriptor_set_out=keelson/interfaces/protobuf_file_descriptor_set.bin \
    --include_imports \
    ../../interfaces/*.proto
...
# keelson.interfaces.* (the registry itself is hand-written in
# keelson/interfaces_registry.py; this generated __init__ only re-exports
# it next to the generated stubs).
cat > keelson/interfaces/__init__.py <<'EOF'
# Generated by generate_python.sh - DO NOT EDIT.
from keelson.interfaces_registry import (
    RpcError,
